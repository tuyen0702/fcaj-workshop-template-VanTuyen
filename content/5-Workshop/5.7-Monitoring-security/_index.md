...
![SNS Topic](/static/images/5-Workshop/5.7-Monitoring-security/sns-topic.png)
...
![Confirm subscription](/static/images/5-Workshop/5.7-Monitoring-security/confirm-subscription.png)
...
![Test](/static/images/5-Workshop/5.7-Monitoring-security/test.png)
...
![Architecture-review-workflow](/static/images/5-Workshop/5.7-Monitoring-security/Architecture-review-workflow.png)
...
![Errors-Alarm](/static/images/5-Workshop/5.7-Monitoring-security/Errors-Alarm.png)
...
![Log Metric Filter](/static/images/5-Workshop/5.7-Monitoring-security/Log-Metric-Filter.png)
...
![AIArchitectureReviewer-APIGateway](/static/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-APIGateway.png)
...
![AIArchitectureReviews-DynamoDB](/static/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviews-DynamoDB.png)
...
![AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm](/static/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm.png)
...
![Lambda-Upload-Service](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service.png)

![Lambda-Upload-Service-Policy](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service-Policy.png)

**Lambda AI Analyzer** requires the following permissions:

![Lambda-AI-Analyzer](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer.png)

![Lambda-AI-Analyzer-Policy](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer-Policy.png)

**Lambda Cost Tool** requires the following permissions:

![Lambda-Cost-Tool](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool.png)

![Lambda-Cost-Tool-Policy](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool-Policy.png)

**Lambda PDF Generator** requires the following permissions:

![Lambda-PDF-Generator](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator.png)

![Lambda-PDF-Generator-Policy](/static/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator-Policy.png)
