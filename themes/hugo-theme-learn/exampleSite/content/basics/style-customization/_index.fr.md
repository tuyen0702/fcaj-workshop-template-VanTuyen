...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/static/images//` et nommez le `favicon.png`
...
![Variante rouge](/en/basics/style-customization/static/images//red-variant.png?width=60pc)
...
![Variante bleue](/en/basics/style-customization/static/images//blue-variant.png?width=60pc)
...
![Variante verte](/en/basics/style-customization/static/images//green-variant.png?width=60pc)
